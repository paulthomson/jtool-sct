...
package rhinotest2.org.mozilla.javascript.optimizer;

import rhinotest2.org.mozilla.classfile.*;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "rhinotest2.org.mozilla.javascript.gen.c"+serial;
...
*/
    ...
    static RuntimeException badTree()
    {
     ...
     static final String DEFAULT_MAIN_METHOD_CLASS
        = "rhinotest2.org.mozilla.javascript.optimizer.OptRuntime";

    private static final String SUPER_CLASS_NAME
        = "rhinotest2.org.mozilla.javascript.NativeFunction";
...
*/
    ...
    {
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "rhinotest2.org.mozilla.javascript.ScriptRuntime",
                      methodName,
                      methodSignature);
    }
