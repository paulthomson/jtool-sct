 ...
 * <pre>
 * import rhinotest2.org.mozilla.javascript.*;
 *
...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link rhinotest2.org.mozilla.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected rhinotest2.org.mozilla.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return rhinotest2.org.mozilla.javascript.xml.XMLLib.Factory.create(
                "rhinotest2.org.mozilla.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return rhinotest2.org.mozilla.javascript.xml.XMLLib.Factory.create(
                "rhinotest2.org.mozilla.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
