...
public class JGFSparseMatmultBench extends SparseMatmult implements JGFSection2{ 
  ...
  private static final int datasizes_M[] = {5,100000,500000};
  private static final int datasizes_N[] = {5,100000,500000};
  private static final int datasizes_nz[] = {25,500000,2500000};
