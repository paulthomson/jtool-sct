...
public class JGFLUFactBench extends Linpack implements JGFSection2{
  ...
  public int nthreads;
  private int size;
  private final int datasizes[] = {10,1000,2000};
  ...
  public void JGFkernel(){
    ...
    Barrier br= new SimpleBarrier(nthreads);
...
//    JGFInstrumentor.startTimer("Section2:LUFact:Kernel");  
    ...
    for(int i=1;i<nthreads;i++) {
       thobjects[i] = new LinpackRunner(i,a,lda,n,ipvt,br, nthreads);
       th[i] = new Thread(thobjects[i]);
       th[i].start();
    }

       thobjects[0] = new LinpackRunner(0,a,lda,n,ipvt,br, nthreads);
       thobjects[0].run();
