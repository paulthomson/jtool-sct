...
public class JGFSORBench extends SORNotUsed implements JGFSection2{ 

  private int size; 
  private final int datasizes[]={1000,1500,2000};
  private static final int JACOBI_NUM_ITER = 2;
  ...
  public void JGFrun(int size){
    ...
    JGFInstrumentor.addTimer("Section2:SORNotUsed:Kernel", "Iterations",size);
    ...
    JGFInstrumentor.addOpsToTimer("Section2:SORNotUsed:Kernel", (double) (JACOBI_NUM_ITER));
 
    JGFInstrumentor.printTimer("Section2:SORNotUsed:Kernel"); 
  }
