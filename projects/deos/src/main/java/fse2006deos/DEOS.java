...
class DEOS {
  ...
  static long seedClock = 0;
  static long idleThreadSeed = 0;
  static long user1Seed = 0;
  static long user2Seed = 0;
  static long deosProcessSeed = 0;
  ...
  public static void main (String[] args) {
    ...
    systemClock = new Clock(thePeriodicClock, theTimer, seedClock);

    DEOSKernel.coldStartKernel(idleThreadSeed, deosProcessSeed);

    int result = DEOSKernel.createThreadK("user1", 0, 21, 1, user1Seed);


    //System.out.println("Thread created status = " + result);
    result = DEOSKernel.createThreadK("user2", 0, 21, 1, user2Seed);
