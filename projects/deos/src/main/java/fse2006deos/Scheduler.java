...
class Scheduler {
  ...
  public static void initialize (long seed, long deosProcessSeed) {
    // JAVA DEOS
    ...
    theProcess = new DEOSProcess(deosProcessSeed);
  ...
  private static void initializeIdleProcess (long seed) {
    //System.out.println("Scheduler.initializeIdleProcess");
    itsIdleThread = new Thread("idle", seed);
