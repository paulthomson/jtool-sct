      ...
      if (opterr)
        {
          ...
          System.err.println("getopt.ambigious");
        }
                  ...
                  if (argv[optind - 1].startsWith("--"))
                    {
                      ...
                      System.err.println("getopt.arguments1");
                    }
                  // +option or -option
                  else
                    {
                      Object[] msgArgs = { progname, new 
                               ...
                               pfound.name };
                      System.err.println("getopt.arguments2");
                    }
                 }
              ...
              if (opterr)
                {
                  ...
                  System.err.println("getopt.requires");
                }
              ...
              if (argv[optind].startsWith("--"))
                {
                  ...
                  System.err.println("getopt.unrecognized");
                }
              else
                {
                  Object[] msgArgs = { progname, new 
                                 ...
                                 nextchar };
                  System.err.println("getopt.unrecognized2");
                }
            }
          ...
          if (posixly_correct)
            {
              ...
              System.err.println("getopt.illegal");
            }
          else
            {
              Object[] msgArgs = { progname, new 
                                   Character((char)c).toString() };
              System.err.println("getopt.invalid");
            }
        }
          ...
          if (opterr)
            {
              ...
              Object[] msgArgs = { progname, new 
                                   Character((char)c).toString() };
              System.err.println("getopt.requires2");
            }
