...
public class TwoStage {
	 ...
	 * It assumes that data2.value=data1.value (This assumption is used to simulate insome
	 * database application, the two value in different tables must be consistant.
	 */
	public void A () {
