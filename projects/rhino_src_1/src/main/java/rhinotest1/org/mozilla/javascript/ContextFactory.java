...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link rhinotest1.org.mozilla.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected rhinotest1.org.mozilla.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return rhinotest1.org.mozilla.javascript.xml.XMLLib.Factory.create(
                "rhinotest1.org.mozilla.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return rhinotest1.org.mozilla.javascript.xml.XMLLib.Factory.create(
                "rhinotest1.org.mozilla.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
