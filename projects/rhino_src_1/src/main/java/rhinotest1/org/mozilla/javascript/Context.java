...
import rhinotest1.org.mozilla.javascript.ast.AstRoot;
import rhinotest1.org.mozilla.javascript.ast.ScriptNode;
import rhinotest1.org.mozilla.javascript.debug.DebuggableScript;
import rhinotest1.org.mozilla.javascript.debug.Debugger;
...
public class Context
{
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(rhinotest1.org.mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    public static void addContextListener(ContextListener listener)
    {
        // Special workaround for the debugger
        String DBG = "rhinotest1.org.mozilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "rhinotest1.org.mozilla.javascript.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(rhinotest1.org.mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
     ...
     *
     * @see rhinotest1.org.mozilla.javascript.ErrorReporter
     */
     ...
     * @see rhinotest1.org.mozilla.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (rhinotest1.org.mozilla.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see rhinotest1.org.mozilla.javascript.Script
     */
    ...
    private static final Class<?> codegenClass = Kit.classOrNull(
                             "rhinotest1.org.mozilla.javascript.optimizer.Codegen");
    private static final Class<?> interpreterClass = Kit.classOrNull(
                             "rhinotest1.org.mozilla.javascript.Interpreter");
    ...
    static Evaluator createInterpreter()
    {
      ...
      return new rhinotest1.org.mozilla.javascript.Interpreter();
    }
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "rhinotest1.org.mozilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
