...
package rhinotest1.org.mozilla.javascript.optimizer;

import rhinotest1.org.mozilla.classfile.*;
import rhinotest1.org.mozilla.javascript.*;
import rhinotest1.org.mozilla.javascript.ast.FunctionNode;
import rhinotest1.org.mozilla.javascript.ast.Jump;
import rhinotest1.org.mozilla.javascript.ast.Name;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "rhinotest1.org.mozilla.javascript.gen." + baseName + "_" + serial;
...
*/
    ...
    static RuntimeException badTree()
    {
     ...
     static final String DEFAULT_MAIN_METHOD_CLASS
        = "rhinotest1.org.mozilla.javascript.optimizer.OptRuntime";

    private static final String SUPER_CLASS_NAME
        = "rhinotest1.org.mozilla.javascript.NativeFunction";
...
*/
    ...
    {
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "rhinotest1.org.mozilla.javascript.ScriptRuntime",
                      methodName,
                      methodSignature);
    }
