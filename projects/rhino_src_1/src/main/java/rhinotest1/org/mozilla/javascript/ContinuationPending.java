...
/**
 * Exception thrown by
 * {@link rhinotest1.org.mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link rhinotest1.org.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link rhinotest1.org.mozilla.javascript.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link rhinotest1.org.mozilla.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
    private static final long serialVersionUID = 4956008116771118856L;
    private final NativeContinuation continuationState;
     ...
     * calling {@link rhinotest1.org.mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link rhinotest1.org.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link rhinotest1.org.mozilla.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
