...
public class DoubleBufferCopy {
    ...
    private static final String DBC01_ = "DBC01 - copy failed with an IOException";
    private static final String DBC02_ = "DBC02 - copy failed, thread was interrupted before";
    private final CopyThread read_;
    private final CopyThread write_;
    private final InputStream ist_;
    private final OutputStream ost_;
    private final Buffer buffer1_;
    private final Buffer buffer2_;
