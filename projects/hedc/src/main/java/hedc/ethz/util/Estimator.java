...
public class Estimator implements Serializable {
    ...
    private static final int EST_MAX_COLUMNS = 100;
    private static final String EST01_ = "EST01 - lower bound (%1) must be below upper bound (%2) in initializer";
    private static final String EST02_ = "EST02 - estimation failed by %1 % (%2)";
