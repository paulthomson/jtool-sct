...
import rhinotest3.org.mozilla.javascript.debug.DebuggableScript;
import rhinotest3.org.mozilla.javascript.debug.Debugger;
...
public class Context
{
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "rhinotest3.org.mozilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class cl = listener.getClass();
            Class factoryClass = Kit.classOrNull(
                "rhinotest3.org.mozilla.javascript.ContextFactory");
     ...
     *
     * @see rhinotest3.org.mozilla.javascript.ErrorReporter
     */
     ...
     * @see rhinotest3.org.mozilla.javascript.SecurityController
     */
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see rhinotest3.org.mozilla.javascript.Script
     */
    ...
    private static final Class codegenClass = Kit.classOrNull(
                             "rhinotest3.org.mozilla.javascript.optimizer.Codegen");
    private static final Class interpreterClass = Kit.classOrNull(
                             "rhinotest3.org.mozilla.javascript.Interpreter");
    ...
    {
      return new rhinotest3.org.mozilla.javascript.Interpreter();
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class cl = Kit.classOrNull(
                          "rhinotest3.org.mozilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
