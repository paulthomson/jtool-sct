...
package rhinotest3.org.mozilla.javascript.optimizer;

import rhinotest3.org.mozilla.classfile.*;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "rhinotest3.org.mozilla.javascript.gen.c"+serial;
...
*/
    ...
    static RuntimeException badTree()
    {
     ...
     static final String DEFAULT_MAIN_METHOD_CLASS
        = "rhinotest3.org.mozilla.javascript.optimizer.OptRuntime";

    private static final String SUPER_CLASS_NAME
        = "rhinotest3.org.mozilla.javascript.NativeFunction";
...
*/
    ...
    {
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "rhinotest3.org.mozilla.javascript.ScriptRuntime",
                      methodName,
                      methodSignature);
    }
