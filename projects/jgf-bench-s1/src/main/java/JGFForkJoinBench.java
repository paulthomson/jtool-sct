...
public class JGFForkJoinBench implements JGFSection1{
  ...
  public JGFForkJoinBench(final int nthreads) {
  ...
  public void JGFrun(){
	...
	// JGFInstrumentor.addOpsToTimer("Section1:ForkJoin:Simple",(double)
	// size);
	// size *=2;
	// }
	...
	// JGFInstrumentor.addTimer("Section1:SerialForkJoin:Simple",
	// "forkjoins");
  ...
  public static void main(final String[] argv) {
     ...
     final JGFForkJoinBench fj = new JGFForkJoinBench(nthreads);
     fj.JGFrun();
...
class ForkJoinThread implements Runnable {
    ...
    public ForkJoinThread(final int id) {
	this.id = id;
    }
