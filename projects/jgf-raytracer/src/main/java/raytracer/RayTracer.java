...
public class RayTracer { 
  ...
  public RayTracer()
  {
	  ...
	  L = new Vec();
	  inter = new Isect();
  	  datasizes = new int[]{4,10,20,50,150,500}; 
  }
...
public void setScene(Scene scene)
    ...
    System.out.println("setScene: init");
    ...
    System.out.println("setScene: lights");
    ...
    System.out.println("setScene: primitives");
